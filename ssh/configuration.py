...
class Config(object):
    def __init__(self, mode='dev'):
        ...
        self.MODES = {
            ...
            "dev": {
                "ssh_key": os.path.abspath("ssh/keys/honeypot.key"),
                "ssl_key": os.path.abspath("ssh/keys/key.pem"),
                "ssl_cert": os.path.abspath("ssh/keys/cert.pem"),
                "https_log": os.path.abspath("ssh/logs/https.log"),
                "http_log": os.path.abspath("ssh/logs/http.log"),
                "ssh_log": os.path.abspath("ssh/logs/ssh.log"),
                "paramiko_log": os.path.abspath("ssh/logs/paramiko.log"),
                "ssh_port": 8022,
                "http_port": 8080,
                "https_port": 8043,
                "crontab_time": "0 * * * *",
